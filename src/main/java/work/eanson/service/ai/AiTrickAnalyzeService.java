 ...
 */
@Service("ai_trick")
public class AiTrickAnalyzeService extends BaseService {
    @Autowired
    ...
    public void service(Context context) throws Exception {
        ...
        try {
            ...
            if (trick.getIsFalse()) {
                ...
                codeHolder.sendMsgToAll(CbSocketEndPoint.usedClients, newPos);
                codeHolder.sendMsgToAll(CbSocketEndPoint.watchClients, newPos);
