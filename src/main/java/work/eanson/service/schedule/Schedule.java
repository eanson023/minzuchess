...
import work.eanson.service.chess.ResetChessService;
...
public class Schedule implements InitializingBean {
    ...
    public static final Logger logger = LogManager.getLogger(Schedule.class);
    ...
    @Autowired
    private ResetChessService resetChessService;
    ...
    public void clearFile() {
        String path = "/data/minzuchess/static/cheep/tmp";
