...
public class OutputCheepService extends BaseService {
    @Autowired
    ...
    public void service(Context context) throws Exception {
        ...
        //绝对路径
        String absolutePath = "/data/minzuchess/static/cheep_/tmp";
        //相对路径
        String relativelyPath = "/cheep_/tmp";
        String fileName = common.getUUID();
