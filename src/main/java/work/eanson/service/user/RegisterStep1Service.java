...
public class RegisterStep1Service extends BaseService {
    @Autowired
    ...
    @Override
    public void service(Context context) throws ParseException, JsonProcessingException {
        ...
        //2.0
        if (!common.isChineseName(realName) || !common.isPassword(password)) {
...
//        暂时用原密码
        ...
        if (isRegHalf) {
            ...
            //设置uuid用于查询用
            userInfo.setUuid(common.getUUID());
